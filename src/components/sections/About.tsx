...
const stats = [
  ...
  { icon: FileCheck, value: "300+", label: "дел сопровождения" },
  { icon: Users, value: "500+", label: "клиентов" },
  { icon: Award, value: "95%", label: "положительных результатов" },
];
...
export function About() {
  ...
  return (
    ...
    <section
      ref={sectionRef}
      id="about"
      className="py-16 lg:py-24 relative overflow-hidden min-h-screen scroll-mt-16"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-amber-100">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
              ...
              Юридическая помощь в Минеральных Водах и по всей России
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              ...
              Компания «ПравоЗакон» оказывает юридическую помощь
              частным лицам и бизнесу.
              Мы сопровождаем клиентов по вопросам банкротства
              физических лиц, списания долгов, судебных споров
              и подготовки юридических документов.
            ...
            <p className="text-gray-700 mb-8 leading-relaxed">
              ...
              Консультации, подготовка документов и сопровождение дел
              доступны онлайн без необходимости постоянного посещения офиса.
            ...
            <div className="bg-gradient-to-br from-amber-700 to-amber-800 rounded-2xl p-8 text-white shadow-xl">
              ...
              <ul className="space-y-5">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p className="leading-relaxed">
                    Работаем дистанционно с клиентами
                ...
                <li className="flex items-start gap-3">
                  ...
                  <p className="leading-relaxed">
                    Понятное объяснение каждого этапа
