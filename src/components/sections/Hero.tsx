...
const advantages = [
  "Работаем дистанционно по всей РФ",
...
export function Hero() {
  return (
    <section className="relative pt-28 lg:pt-40 pb-24 lg:pb-36 overflow-hidden min-h-screen scroll-mt-16">
      <div 
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: "url('/images/1.png')", backgroundSize: "cover" }}
      />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-amber-100">
            ...
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Юридическая помощь{" "}
              <span className="text-amber-700">по всей России</span>
            </h1>
            
            <p className="text-lg lg:text-xl text-gray-700 mb-8 max-w-lg">
              Банкротство, защита от приставов, судебные споры. 
              Работаем дистанционно — без вашего личного присутствия.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              <Button size="lg" className="gap-2 animate-pulse bg-amber-600 hover:bg-amber-700" onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })}>
          ...
          <div className="relative hidden lg:block">
            <div className="relative z-10 bg-white rounded-2xl shadow-2xl p-8 border border-amber-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <p className="font-semibold text-gray-900">Дело выиграно</p>
                  <p className="text-sm text-gray-500">Арбитражный суд, 2024</p>
                </div>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-amber-100 flex justify-between items-center">
                <span className="text-gray-500">Списано долгов</span>
                <span className="text-2xl font-bold text-amber-700">2.5 млн ₽</span>
              </div>
            </div>
