...
const contactInfo = [
  { icon: Phone, label: "Телефон", value: "+7 (995) 000-04-17", href: "tel:+79950000417" },
  { icon: Mail, label: "Email", value: "kardanova.zainab@mail.ru", href: "mailto:kardanova.zainab@mail.ru" },
  { icon: MapPin, label: "Адрес", value: "ул. Терешкова, 26, Минеральные Воды", href: "#" },
...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-12 lg:py-16 relative overflow-hidden scroll-mt-16">
      <div 
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: "url('/images/4.jpg')", backgroundSize: "cover" }}
      />
      <div className="absolute inset-0 bg-white/40" />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-12 lg:mb-16">
          <p className="text-amber-700 font-semibold mb-2">Контакты</p>
